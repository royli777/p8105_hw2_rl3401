...
*Only 2355 participants appear in both the baseline dataset and the
amyloid dataset, meaning that there are 88 participants whose data only
appear in one dataset.*

*The resulting dataset of participants who appear in both baseline and
amyloid datasets have 2355 rows and 8 columns, the variables in the
dataset are: id, current_age, sex, education, apoe4, age_at_onset, time,
amyloid.*
